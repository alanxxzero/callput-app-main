...
export const TOKEN_INFO = {
  ...
  HONEY: {
    ADDRESS: "0xd137593CDB341CcC78426c54Fb98435C60Da193c",
    DECIMAL: 18
  }
}
...
export const OLP_TOKEN_INFO = {
  ...
  HONEY: {
    WEIGHT: 5000,
    BUFFER_AMOUNT: new BigNumber(40000).multipliedBy(10 ** TOKEN_INFO.HONEY.DECIMAL).toString(), // 40000_000000000000000000
    MAX_USDG_AMOUNT: new BigNumber(30000000).multipliedBy(10 ** 18).toString(), // $30,000,000
    DECREASE_TOLERANCE_AMOUNT: 10000000
  }
}
