...
import { CHAINLINK_FLAGS, CHAINLINK_PRICE_FEED_USDC, CHAINLINK_PRICE_FEED_WBTC, CHAINLINK_PRICE_FEED_WETH, CHAINLINK_TOKEN_DECIMALS, btcMaxUsdgAmount, btcTokenWeight, ethMaxUsdgAmount, ethTokenWeight, mpReleaseDuration, referralDiscountRate, referralFeeRebateRate, rpReleaseDuration, settleFeeCalculationLimitRate, socialTradingLeaderFeeRebateRate, tradeFeeCalculationLimitRate, usdcBufferAmounts, usdcMaxUsdgAmount, usdcTokenWeight, wbtcBufferAmounts, wethBufferAmounts } from "./constants";
