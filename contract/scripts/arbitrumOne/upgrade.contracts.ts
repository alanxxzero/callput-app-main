...
export async function upgradeContracts(ethers: any, addressMap: any) {
  ...
  /*
   * [2024-10-23] Upgrade PositionManager, Controller, Vault, VaultUtils, OptionsMarket, FeeDistributor, and ViewAggregator for integration with Berachain
   */
  // await sVaultAfterUpgrades.setDecreaseToleranceAmount(CONTRACT_ADDRESS.WBTC, "20000")
  // await sVaultAfterUpgrades.setDecreaseToleranceAmount(CONTRACT_ADDRESS.WETH, "4000000000000000")
  // await sVaultAfterUpgrades.setDecreaseToleranceAmount(CONTRACT_ADDRESS.USDC, "10000000")
  // await mVaultAfterUpgrades.setDecreaseToleranceAmount(CONTRACT_ADDRESS.WBTC, "20000")
  // await mVaultAfterUpgrades.setDecreaseToleranceAmount(CONTRACT_ADDRESS.WETH, "4000000000000000")
  // await mVaultAfterUpgrades.setDecreaseToleranceAmount(CONTRACT_ADDRESS.USDC, "10000000")
