...
contract RewardRouterV2 is IRewardRouterV2, OwnableUpgradeable, ReentrancyGuardUpgradeable, AuthorityUtil {
    ...
    function mintAndStakeOlpTo(address _token, uint256 _amount, uint256 _minUsdg, uint256 _minOlp, address _receiver) external nonReentrant returns (uint256) {
        return _mintAndStakeOlp(msg.sender, _receiver, _token, _amount, _minUsdg, _minOlp);
    }
