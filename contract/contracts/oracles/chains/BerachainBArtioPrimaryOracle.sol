...
import "./interfaces/IBerachainBArtioPrimaryOracle.sol";
...
contract BerachainBArtioPrimaryOracle is IPrimaryOracle, IBerachainBArtioPrimaryOracle, OwnableUpgradeable, AuthorityUtil {
    ...
    function getPrice(address _token, bool _maximise) public override view returns (uint256) {
        revert ("BerachainPrimaryOracle: NOT_IMPLEMENTED");
    }
}
