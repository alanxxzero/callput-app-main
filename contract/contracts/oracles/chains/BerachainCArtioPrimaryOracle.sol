...
import "./interfaces/IBerachainCArtioPrimaryOracle.sol";
...
contract BerachainCArtioPrimaryOracle is IPrimaryOracle, IBerachainCArtioPrimaryOracle, OwnableUpgradeable, AuthorityUtil {
    ...
    function getPrice(address _token, bool _maximise) public override view returns (uint256) {
        revert ("BerachainCArtioPrimaryOracle: NOT_IMPLEMENTED");
    }
}
