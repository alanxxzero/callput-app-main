...
import "./interfaces/IBerachainMainnetPrimaryOracle.sol";
...
contract BerachainMainnetPrimaryOracle is IPrimaryOracle, IBerachainMainnetPrimaryOracle, OwnableUpgradeable, AuthorityUtil {
    ...
    function getPrice(address _token, bool _maximise) public override view returns (uint256) {
        revert ("BerachainMainnetPrimaryOracle: NOT_IMPLEMENTED");
    }
}
