...
interface IPositionValueFeed {
    ...
    function feedPV(address[] memory _vaults, uint256[] memory _pv, bool[] memory _isPvNegative, uint256 _deadline) external;
    function feedPV_V2(address[] memory _vaults, uint256[] memory _pv, bool[] memory _isPvNegative, uint256 _positionKeysStart, uint256 _deadline) external;
    ...
    function feedAPV(address[] memory _vaults, uint256[] memory _apv, uint256 _deadline) external;
