...
export const checkKeeperBalances = async () => {
  try {
    ...
    const addresses = {
      ...
      positionValueFeeder_sub1: keeper_positionValueFeeder_sub1.address,
      spotPriceFeeder: keeper_spotPriceFeeder.address,
      spotPriceFeeder_sub1: keeper_spotPriceFeeder_sub1.address,
    ...
    const [
      ...
      positionValueFeeder_sub1Balance,
      spotPriceFeederBalance,
      spotPriceFeeder_sub1Balance,
      ...
      provider.getBalance(keeper_positionValueFeeder_sub1.address),
      provider.getBalance(keeper_spotPriceFeeder.address),
      provider.getBalance(keeper_spotPriceFeeder_sub1.address),
    ...
    const balances = {
      ...
      positionValueFeeder_sub1: positionValueFeeder_sub1Balance,
      spotPriceFeeder: spotPriceFeederBalance,
      spotPriceFeeder_sub1: spotPriceFeeder_sub1Balance,
    ...
    for (const [key, balance] of Object.entries(balances)) {
      if (Number(formatEther(balance)) < 0.1) shouldAlert = true;
