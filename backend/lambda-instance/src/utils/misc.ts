...
import REQUIREMENTS from "../constants/constants.requirements"
...
export const getDeadline = (chainId) => {
  // as solidity seconds
  const deadline = dayjs().unix() + REQUIREMENTS[chainId].DEADLINE_SECONDS;
  return deadline
}