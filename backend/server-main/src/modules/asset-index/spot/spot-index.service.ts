...
import { NormalizedSpotAsset, MultipleAssetIndexMapRes, NormalizedAssetType } from '@moby/shared';
...
export class SpotIndexService extends WeightedAssetIndexService<NormalizedSpotAsset> {
  ...
  protected readonly assets: NormalizedSpotAsset[] = ['BTC', 'ETH', 'USDC', 'HONEY'];
