...
import VaultQueueEventsAbi from '../../../shared/abis/VaultQueueEvents.json'
...
import { 
  ...
  TransferSingleTopic,
  ActionEnqueuedTopic,
  ActionProcessedTopic,
  ActionCancelledTopic,
  ActionPushedbackTopic,
} from './utils/topics'
...
import { handleActionCancelled, handleActionEnqueued, handleActionProcessed, handleActionPushedback } from './utils/mappingHandlers.spv'
import { ChainId } from './networks'
import { isChain } from './utils/helper'
...
export const schedules = [
  ...
  isChain(ChainId.BERACHAIN_MAINNET) && [
    { address: CONTRACT_ADDRESSES[process.env.CHAIN_ID].VAULT_QUEUE_EVENTS, topic: ActionEnqueuedTopic, abi: VaultQueueEventsAbi, handler: handleActionEnqueued },
    { address: CONTRACT_ADDRESSES[process.env.CHAIN_ID].VAULT_QUEUE_EVENTS, topic: ActionProcessedTopic, abi: VaultQueueEventsAbi, handler: handleActionProcessed },
    { address: CONTRACT_ADDRESSES[process.env.CHAIN_ID].VAULT_QUEUE_EVENTS, topic: ActionCancelledTopic, abi: VaultQueueEventsAbi, handler: handleActionCancelled },
    { address: CONTRACT_ADDRESSES[process.env.CHAIN_ID].VAULT_QUEUE_EVENTS, topic: ActionPushedbackTopic, abi: VaultQueueEventsAbi, handler: handleActionPushedback },
  ]
]
