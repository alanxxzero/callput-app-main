...
import { IMarketSlice, ILeadTraders } from "@/interfaces/interfaces.marketSlice";
...
import { getMainOptionStrikePrice, getInstrumentOptionDataFromMarket, parseOptionTokenId, UnderlyingAsset, FuturesAssetIndexMapRes } from "@moby/shared";
  ...
  extraReducers: (builder) => {
    builder
      .addCase(loadMarketData.fulfilled, (state, action: PayloadAction<any>) => {
        ...
        if (olpStats) {
          // Create a deep copy of olpStats with default values for honey when needed
          const safeOlpStats = {
            sOlp: {
              ...olpStats.sOlp,
              assetAmounts: {
                ...olpStats.sOlp.assetAmounts,
                honey: olpStats.sOlp.assetAmounts.honey || {
                  utilizedAmount: 0,
                  availableAmount: 0,
                  depositedAmount: 0
                }
            ...
            mOlp: {
              ...
              assetAmounts: {
                ...
                honey: olpStats.mOlp.assetAmounts.honey || {
                  utilizedAmount: 0,
                  availableAmount: 0,
                  depositedAmount: 0
                }
            ...
            lOlp: {
              ...
              assetAmounts: {
                ...
                honey: olpStats.lOlp.assetAmounts.honey || {
                  utilizedAmount: 0,
                  availableAmount: 0,
                  depositedAmount: 0
                }
...
export const { updateFuturesAssetIndexMap } = marketSlice.actions;
