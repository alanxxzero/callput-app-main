...
import { generateOptionTokenData, getMainOptionName, getMainOptionStrikePrice, getPairedOptionStrikePrice } from "@moby/shared";
...
export const startPolling = () => {
  if (!pollingIntervalId && pendingTx.length > 0) {
    pollingIntervalId = setInterval(checkPendingTx, 2 * 1000);
