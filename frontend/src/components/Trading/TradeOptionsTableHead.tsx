  ...
  return (
    ...
    >
      <span className="pl-[40px]">
        ...
        >
          <span className="border-b-[1px] border-dashed border-b-greenc1">Strike Price</span>
        </WithTooltip>
      </span>
      ...
      <div className="flex flex-row justify-center">
        <div className="flex flex-row justify-center">
          ...
          <div className="relative group cursor-help w-fit font-semibold border-b-[1px] border-dashed border-b-greenc1">
            <p className="text-gray80 text-[14px] hover:text-greenc1 ">Bid Price</p>
          ...
          <div><p className="mx-[5px]">/</p></div>
          
          {/* Tooltip 2 */}
          <div className="relative group cursor-help w-fit font-semibold border-b-[1px] border-dashed border-b-greenc1">
            <p className="text-gray80 text-[14px] hover:text-greenc1 ">IV</p> <p></p>
            <div className={twJoin(
              "w-max h-[42px] z-20",
              "absolute hidden px-[11px] py-[6px] bottom-[24px] -left-[12px]",
              "bg-black1f rounded-[4px] border-[1px] border-[rgba(224,224,224,.1)] shadow-[0_0_8px_0_rgba(10,10,10,.72)]",
      ...
      <div className="flex flex-row justify-center">
        ...
        <WithTooltip
          tooltipContent={(
            <p className="text-[12px] text-gray80 leading-[0.85rem]">Model Price of options calculated using Black-76 fomula</p>
          )}
          tooltipClassName={twJoin(
            "w-[227px]",
          )}
      ...
      <div className="flex flex-row justify-center">
        <div className="flex flex-row justify-center">
          ...
          {/* Tooltip 4 */}
          <div className="relative group cursor-help w-fit font-semibold border-b-[1px] border-dashed border-b-greenc1">
            <p className="text-gray80 text-[14px] hover:text-greenc1 ">Ask Price</p>
            <div className={twJoin(
              "w-max h-[42px] z-20",
              "absolute hidden px-[11px] py-[6px] bottom-[24px] -left-[12px]",
              "bg-black1f rounded-[4px] border-[1px] border-[rgba(224,224,224,.1)] shadow-[0_0_8px_0_rgba(10,10,10,.72)]",
