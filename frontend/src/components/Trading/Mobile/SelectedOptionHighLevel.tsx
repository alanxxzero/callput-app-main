...
import { BaseQuoteAsset, calculateRiskPremiumRate, convertQuoteAssetToNormalizedSpotAsset, FEE_RATES, NetworkQuoteAsset, SpotAssetIndexMap, TRADE_FEE_CALCULATION_LIMIT_RATE, UnderlyingAsset, VolatilityScore } from "@moby/shared";
          ...
          >
            <input
              ...
              className={twJoin(
                ...
                "font-plex-mono font-bold text-[#E6FC8D]",
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  <p
                    className={twJoin(
                      "font-plex-mono font-semibold text-whitef0",
                  ...
                  <div
                    className={twJoin(
                      ...
                      "font-plex-mono font-semibold text-greene6",
            ...
            <div className="flex flex-col gap-y-3">
              <div className="flex flex-row justify-between items-center">
                ...
                {isComboMode ? (
                  <p
                    className={twJoin(
                      "font-plex-mono font-semibold text-gray9D h-fit",
                      "text-[12px] leading-[18px] md:text-[14px] md:leading-[20px]"
                    )}
                  >
