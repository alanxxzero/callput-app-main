...
import { FEE_RATES, isCallStrategy, isVanillaCallStrategy, NetworkQuoteAsset, parseOptionTokenId, SETTLE_FEE_CALCULATION_LIMIT_RATE, SpotAssetIndexMap, UnderlyingAsset } from "@moby/shared";
        ...
        >
          ...
          >
            ...
            <div className="flex flex-row justify-between items-baseline font-semibold h-fit">
              ...
              <div className="flex flex-col items-end">
                {isBuy ? (
                  <p className="h-[18px] text-contentBright font-ibm">-</p>
                ) : (
                  <div className="h-[35px]">
                    <div className="flex flex-row text-xs md:text-sm text-contentBright font-ibm">
            ...
            <div className="flex flex-row justify-between items-center font-semibold h-[18px] mt-[6px]">
              ...
              <div className="text-sm md:text-base text-contentBright font-ibm">
                <p>
            ...
            <div className="flex flex-row justify-between items-center font-semibold h-[18px] mt-[6px]">
              ...
              <div className="text-sm md:text-base font-ibm">
                {settlePayoffUsd === 0 ? (
          ...
          <div className="flex flex-col mx-3 md:mx-6 mb-[60px]">
            <div className="flex flex-row justify-between items-center">
              ...
              <div className="flex flex-row items-center text-[18px] md:text-[20px] text-contentBright font-semibold font-ibm">
