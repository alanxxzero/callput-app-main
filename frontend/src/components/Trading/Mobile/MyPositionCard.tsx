...
import { getMainOptionName, getPairedOptionName, getStrategyByOptionTokenId, getStrikePriceByInstrument, isCallStrategy, isSpreadStrategy, UnderlyingAssetWithAll } from "@moby/shared";
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex">
                          ...
                          <div className="flex-1 flex justify-end text-sm md:text-base font-ibm">
                            {position["isBuy"] === true ? (
                        ...
                        <div className="flex">
                          ...
                          <div className="flex-1 flex justify-end text-contentBright text-sm font-ibm">
                            {isExpired ? (
                        ...
                        {!isExpired ? (
                            ...
                            <>
                              <div className="group relative flex flex-row items-center justify-between gap-[12px]">
                                <SharePositionButtonForMobile
                                  ...
                                  title="Share"
                                />
                                <button className="w-fit h-[27px] py-[6px] px-[10px] rounded-[20px] text-[10px] md:text-[12px] text-gray9D font-semibold border-[0.5px] border-gray9D font-ibm">
                                  <CountdownTimer
                                    className="text-gray9D font-ibm"
                          ...
                          <>
                            <div className="flex flex-row items-center justify-end">
                              <button
                                className="h-[27px] py-[6px] px-[10px] rounded-[20px] text-[10px] md:text-[12px] text-gray9D font-semibold border-[0.5px] border-gray9D font-ibm"
                                onClick={() => {
                                  return;
                                }}
                              >
