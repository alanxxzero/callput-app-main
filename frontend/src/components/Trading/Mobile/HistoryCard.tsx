...
import { generateOptionTokenData, getMainOptionName, getPairedOptionStrikePrice, isBuyStrategy, isCallStrategy, isSellStrategy, isSpreadStrategy, isVanillaCallStrategy, parseOptionTokenId, UnderlyingAssetWithAll } from "@moby/shared";
    ...
    >
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex">
          ...
          <div className="flex-1 flex gap-1 justify-end text-sm md:text-base font-ibm">
            {isBuyStrategy(strategy) ? (
        ...
        <div className="flex gap-3 justify-between items-center">
          ...
          <p className="flex items-center justify-center text-gray9D font-semibold text-[10px] md:text-[12px] rounded-[20px] border-[1px] border-gray9D opacity-50 px-[10px] py-[6px] font-ibm">
            {parsedType}
          </p>
        </div>
      </div>
