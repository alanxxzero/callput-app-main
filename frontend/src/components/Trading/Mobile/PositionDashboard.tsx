...
import { getMainOptionName, getPairedOptionName, getStrategyByOptionTokenId, getStrikePriceByInstrument, NormalizedSpotAsset, SpotAssetIndexMap, UnderlyingAssetWithAll } from "@moby/shared";
    ...
    <div className={twJoin("flex flex-wrap justify-between gap-[10px] p-3 md:p-6")}>
      <div className="w-[45%] flex flex-col items-start gap-[2px]">
        ...
        <div className="flex flex-row">
          <p className="text-[18px] md:text-[20px] leading-[24px] font-bold text-contentBright font-ibm">
