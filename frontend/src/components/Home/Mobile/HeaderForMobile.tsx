...
import IconSocialFauset from "@assets/mobile/icon-social-fauset.svg";
...
import IconSocialBlog from "@assets/mobile/icon-social-blog.svg";
import IconSocialEmail from "@assets/mobile/icon-social-email.svg";
