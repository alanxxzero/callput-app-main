...
import LogoBeraSelected from '@assets/chains/icon-bera-sel.svg';
import LogoBeraUnselected from "@assets/chains/icon-bera-unsel.svg";
...
const TOGGLE_CHAIN_SUPPORTED_NETWORK_CLASS: any = {
  ...
  [SupportedChains["Berachain Mainnet"]]: {
    logoSrc: LogoBeraUnselected,
    selectedLogoSrc: LogoBeraSelected,
    className: "bg-transparent",
