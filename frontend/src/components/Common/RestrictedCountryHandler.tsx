...
import { MOBY_TERMS_AND_CONDITIONS_URL } from '@/utils/urls';
    ...
    <div
      ...
      >
        ...
        >
          ...
          <br/>
          <br/>
          Please refer to our <span className='cursor-pointer text-greenc1 font-semibold' onClick={() => window.open(MOBY_TERMS_AND_CONDITIONS_URL, "_blank")}>Terms & Conditions</span> for additional information.
        </div>
      </div>
    </div>
  )
