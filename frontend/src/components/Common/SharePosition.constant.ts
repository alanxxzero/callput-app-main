...
export const CARD_CONCEPT_INFO: CardConceptInfo = {
  [CardConcept.Bera1]: { name: "Bera 1", thumbnailProfit: IconCircleBera1Profit, thumbnailLoss: IconCircleBera1Loss, imgProfit: BgConceptBera1Profit, imgLoss: BgConceptBera1Loss },
  [CardConcept.Bera2]: { name: "Bera 2", thumbnailProfit: IconCircleBera2Profit, thumbnailLoss: IconCircleBera2Loss, imgProfit: BgConceptBera2Profit, imgLoss: BgConceptBera2Loss },
  [CardConcept.MuscleWhale]: { name: "Muscle Whale", thumbnailProfit: IconCircleMuscleWhaleProfit, thumbnailLoss: IconCircleMuscleWhaleLoss, imgProfit: BgConceptMuscleWhaleProfit, imgLoss: BgConceptMuscleWhaleLoss },
