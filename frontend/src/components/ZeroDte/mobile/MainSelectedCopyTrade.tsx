...
import { TWITTER_BASE_URL } from "@/utils/urls";
import { generateOptionTokenData, getMainOptionName, getMainOptionStrikePrice, getPairedOptionName, isCallStrategy, Strategy } from "@moby/shared";
    ...
    <div className={twJoin("flex flex-col gap-y-5 px-3 md:px-6")}>
      <div className="flex flex-row justify-between items-center">
        ...
        {showTwitterInfo && (
          <div
            ...
            onClick={() => {
              window.open(TWITTER_BASE_URL + userName);
            }}
          >
            <img
      ...
      >
        <div className="flex flex-row justify-between">
          ...
          <p
            className={twJoin(
              "font-semibold font-plex-mono text-whitef0 text-end",
              "text-[14px] leading-[21px] md:text-[16px]"
            )}
          >
        ...
        <div className="flex flex-row justify-between">
          ...
          <p
            className={`font-semibold font-plex-mono ${textColorByProfit} text-[14px] leading-[21px] md:text-[16px]`}
          >
