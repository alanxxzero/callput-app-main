...
import { calculateRiskPremiumRate, BaseQuoteAsset, calculateUnderlyingFutures, NetworkQuoteAsset, UnderlyingAsset, VolatilityScore, FuturesAssetIndexMap, RiskFreeRateCollection, SpotAssetIndexMap, convertQuoteAssetToNormalizedSpotAsset, TRADE_FEE_CALCULATION_LIMIT_RATE, FEE_RATES } from "@moby/shared";
...
const MainSelectedZeroDte: React.FC<MainSelectedZeroDteProps> = ({
  ...
  useEffect(() => {
    const quoteTokenList = QA_LIST[chain].filter((quoteAsset: any) => {
      if (isBerachain) {
        if (quoteAsset === "ETH") return false;
      } else {
        if (quoteAsset === "HONEY") return false;
      }
            ...
            >
              ...
              >
                <div className="flex flex-row justify-between items-center">
                  ...
                  <p
                    className={twJoin(
                      "font-semibold font-plex-mono text-whitef0 text-[14px] leading-[21px] md:text-[16px]"
                    )}
                  >
    ...
    >
      <div className={twJoin("flex flex-row justify-between")}>
        ...
        <div className={twJoin("flex flex-row gap-x-[6px] items-center")}>
          ...
          <p
            className={twJoin(
              "font-semibold font-plex-mono text-whitef0",
      ...
      >
        <input
          ...
          className={twJoin(
            ...
            "focus:outline-none font-plex-mono placeholder:font-plex-mono",
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row items-center gap-x-1">
        <p
          className={twJoin(
            "font-plex-mono font-semibold text-gray9D",
