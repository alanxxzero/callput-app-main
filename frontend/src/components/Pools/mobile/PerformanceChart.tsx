      ...
      {isBerachain && (
        <div
          className={twJoin(
            ...
            'w-full h-full',
            'bg-[#1A1A1AD9] backdrop-blur-[2px] z-[9]',
            'flex items-center justify-center text-center text-whitee0',
          )}
        >
          This chart will be available <br /> once Berachain Mainnet goes live.
        </div>
      )}
      <div
        className={twJoin(
      ...
      >
        ...
        <div className='flex flex-row'>
          <div className={twJoin('flex flex-col')}>
            <p
              className={twJoin(
                'text-sm md:text-base font-bold text-contentBright text-right font-ibm',
              )}
            >
          ...
          >
            <p
              className={twJoin(
                'text-sm md:text-base font-bold text-right font-ibm',
