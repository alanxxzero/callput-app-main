...
import SoicalMedium from "../assets/mobile/social-medium.svg";
import SoicalMediumSelected from "../assets/mobile/social-medium-selected.svg";

import { MOBY_DISCORD_URL, MOBY_DOCS_URL, MOBY_MEDIUM_URL, MOBY_TWITTER_URL } from "@/utils/urls";
